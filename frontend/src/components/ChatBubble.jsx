    ...
    return (
      <div className="flex justify-end animate-fade-in group">
        <div className="flex flex-col items-end gap-2 max-w-[85%] sm:max-w-[70%]">
          <div className="flex items-center gap-2 text-xs tracking-widest uppercase font-bold text-accent">
            <span className="opacity-70">候选人_节点</span>
            <User size={14} />
          </div>
          <div className="px-6 py-5 border border-accent/30 bg-accent/5 text-text text-base font-sans leading-relaxed whitespace-pre-wrap relative overflow-hidden">
  ...
  return (
    <div className="flex flex-col animate-fade-in group">
      <div className="flex flex-col items-start gap-2 max-w-full md:max-w-[90%] mb-4">
        <div className="flex items-center gap-2 text-xs tracking-widest uppercase font-bold text-primary">
          <Terminal size={14} />
          <span className="opacity-70">系统_节点</span>
        </div>
        <div className="px-6 py-6 border border-primary/20 bg-bg-subtle/80 backdrop-blur-sm text-base text-text leading-relaxed font-sans relative w-full group-hover:border-primary/40 transition-colors">
